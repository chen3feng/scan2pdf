...
def ocr_image_to_hocr(image_path: Path, lang: str = "eng",
                       tesseract_cmd: str = "tesseract") -> str:
    """
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        if not hocr_file.exists():
            raise RuntimeError(
                f"Tesseract failed to produce hOCR output.\n"
...
def ocr_image_to_text(image_path: Path, lang: str = "eng",
                       tesseract_cmd: str = "tesseract") -> str:
    """
